...
from teacher.onlineExercise.onlineExercise import create_exercise, getexercise, gettheFile, stu_submit, getsubmission, \
    teagetsubmission, correct_exercise, getstusubmission
...
def upload():
    ...
    for stuid in studentid_list:
        create_exercise(teacherid,stuid,title,targetclass,file_data)
    return '文件上传成功'
...
def uploadfromdb():
    ...
    for stuid in studentid_list:
        create_exercise(teacherid,stuid,title,targetclass,filecontent)
    return '文件上传成功'
